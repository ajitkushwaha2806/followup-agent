...
import { MapPin, UtensilsCrossed, Copy, Check, Sparkles } from "lucide-react";

export default function RestaurantCard({ restaurant, merchantUser }) {
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center lg:flex-col lg:items-end gap-2.5">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white text-xs font-semibold shadow-sm hover:shadow-md shadow-red-600/20 transition-all cursor-pointer"
              >
